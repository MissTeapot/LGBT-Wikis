...
The false beliefs of this ideology are precisely the assumptions that asexuality as a social movement aims to refute, many of which are listed explicitly in [What is asexuality?: Asexuality as a social movement](w/asexuality/what_is_asexuality#wiki_asexuality_as_a_social_movement). In broad stokes, these assumptions assert that
...
^9 For definition of 'allosexuality' and further discussion about this term see [The term 'allo'](w/asexuality/allo).
